...
describe('Wayfinding', function () {
	...
	beforeEach(function (done) {
		...
		$example.wayfinding({
			'maps': [
				{ 'path': 'base/test/fixtures/library_floor_1.svg', 'id': 'floor1' },
				{ 'path': 'base/test/fixtures/library_floor_2.svg', 'id': 'floor2' },
				{ 'path': 'base/test/fixtures/library_floor_3.svg', 'id': 'floor3' },
				{ 'path': 'base/test/fixtures/library_floor_B.svg', 'id': 'floor0' }
